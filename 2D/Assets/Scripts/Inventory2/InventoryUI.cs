...
public class InventoryUI : MonoBehaviour
{
    ...
    void Start()
    {
        // slotHolder의 자식 오브젝트들에서 Slot컴포넌트를 한번에 배열로 가져오기
        slots = GetComponentsInChildren<Slot>();

        // inventoryPanel의 활성화 상태를 activeInventory 값으로 변경
    ...
    void Update()
    {
        ...
        {
            // 현재 activeInventory의 반대상태(Not)을 activeInventory에 담아준다.
